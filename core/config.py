...
STT_EGYPTIAN_DIALECT_ONLY = True
WHISPER_MODEL = _env("JARVIS_WHISPER_MODEL", "base")
WHISPER_DEVICE = _env("JARVIS_WHISPER_DEVICE", "cpu")
WHISPER_COMPUTE_TYPE = "int8"
WHISPER_LANGUAGE_HINT = str(_env("JARVIS_WHISPER_LANGUAGE_HINT", "auto")).strip().lower()
if WHISPER_LANGUAGE_HINT in {"arabic", "ar"}:
    WHISPER_LANGUAGE = "ar"
elif WHISPER_LANGUAGE_HINT in {"english", "en"}:
    WHISPER_LANGUAGE = "en"
else:
...
LLM_CPU_UPGRADE_TEST_ENABLED = _env_bool("JARVIS_LLM_CPU_UPGRADE_TEST_ENABLED", True)
