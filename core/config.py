...
WAKE_WORD_AR_CHUNK_SECONDS = max(0.8, _env_float("JARVIS_WAKE_WORD_AR_CHUNK_SECONDS", 2.0))
WAKE_WORD_AR_CHECK_INTERVAL_SECONDS = max(0.5, _env_float("JARVIS_WAKE_WORD_AR_CHECK_INTERVAL_SECONDS", 2.0))
WAKE_WORD_AR_CONSECUTIVE_HITS_REQUIRED = max(1, _env_int("JARVIS_WAKE_WORD_AR_CONSECUTIVE_HITS_REQUIRED", 1))
...
LLM_CPU_UPGRADE_MODEL = _env("JARVIS_LLM_CPU_UPGRADE_MODEL", "qwen3:4b")
...
# Phase 4.1 — Function-calling tier (Tier 3.5 in the intent cascade)
TOOL_CALLING_ENABLED = _env_bool("JARVIS_TOOL_CALLING_ENABLED", True)
TOOL_CALLING_MIN_TIER = _env("JARVIS_TOOL_CALLING_MIN_TIER", "medium")

# Phase 4.2 — Mixed-language (code-switching) normalization
CODESWITCHING_ENABLED = _env_bool("JARVIS_CODESWITCHING_ENABLED", True)
